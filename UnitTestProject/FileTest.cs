...
namespace UnitTestProject
{
    ...
    public class FileTest
    {
        ...
        static object[] NullFilesData =
        {
            new object[] {new File(), null, null}
        };
        ...
        [Test, TestCaseSource(nameof(NullFilesData))]
        public void GetSizeNullFileTest(File nullFile, String name, String content)
        {
            lenght = 0;
            Assert.AreEqual(nullFile.GetSize(), lenght, SIZE_EXCEPTION);
        }

        /* Тестируем получение имени */
        [Test, TestCaseSource(nameof(NullFilesData))]
        public void GetFilenameNullFileTest(File nullFile, String name, String content)
        {
            Assert.AreEqual(nullFile.GetFilename(), name, NAME_EXCEPTION);
        }
    }
}
